...
def sequence_prediction(path):
    ...
    recon = keras.models.load_model("C:/Users/Dell/OneDrive/Desktop/Desk/React + Flask/model_inception_ANN.h5")
    recon2= keras.models.load_model("C:/Users/Dell/OneDrive/Desktop/Desk/React + Flask/model_inception_LSTM.h5")
    recon1= keras.models.load_model("C:/Users/Dell/OneDrive/Desktop/Desk/React + Flask/model_inception_GRU.h5")
    ...
    probabilities2 = recon1.predict([frame_features, frame_mask])[0]    
    res2=[]
    for i in np.argsort(probabilities2)[::-1]:
        # gru
        print(f"{class_vocab[i]}: {probabilities2[i] * 100:5.2f}%")
        x = f"{class_vocab[i]}: {probabilities2[i] * 100:5.2f}%"
        res2.append(x)    
